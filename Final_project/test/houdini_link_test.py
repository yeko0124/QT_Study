...
from libs.hou_lib import render as hou_render


class HTest(QtWidgets.QMainWindow):
    ...
    # todo usd(rop)name의 파일이 이미 존재할 경우,
    #  파일의 개수를 읽어와서 version 카운트 이어갈 수 있기 위한 메서드
    def read_file_version(self) -> int:
        pass

    def make_post_file(self, usd_name) -> str:
        with open('/Users/yeko/Desktop/netflix_TD/Final_project/libs/hou_lib/post_render_pre_input.py', 'r') as original_file:
